...
var testFixtures = [
	{
		...
		tests: [
			{ input: '`',  output: 'ژ', description: '`' -> 'ژ' },
			{ input: '1',  output: '١', description: '1' -> '١' },
			{ input: '2',  output: '٢', description: '2' -> '٢' },
			{ input: '3',  output: '٣', description: '3' -> '٣' },
			{ input: '4',  output: '٤', description: '4' -> '٤' },
			{ input: '5',  output: '٥', description: '5' -> '٥' },
			{ input: '6',  output: '٦', description: '6' -> '٦' },
			{ input: '7',  output: '٧', description: '7' -> '٧' },
			{ input: '8',  output: '٨', description: '8' -> '٨' },
			{ input: '9',  output: '٩', description: '9' -> '٩' },
			{ input: '0',  output: '٠', description: '0' -> '٠' },

			{ input: 'q',  output: 'چ', description: 'q' -> 'چ' },
			{ input: 'w',  output: 'ص', description: 'w' -> 'ص' },
			{ input: 'e',  output: 'پ', description: 'e' -> 'پ' },
			{ input: 'r',  output: 'ق', description: 'r' -> 'ق' },
			{ input: 't',  output: 'ف', description: 't' -> 'ف' },
			{ input: 'y',  output: 'غ', description: 'y' -> 'غ' },
			{ input: 'u',  output: 'ع', description: 'u' -> 'ع' },
			{ input: 'i',  output: 'ھ', description: 'i' -> 'ھ' },
			{ input: 'o',  output: 'خ', description: 'o' -> 'خ' },
			{ input: 'p',  output: 'ح', description: 'p' -> 'ح' },
			{ input: '[',  output: 'ج', description: '[' -> 'ج' },
			{ input: ']',  output: 'د', description: ']' -> 'د' },

			{ input: 'a',  output: 'ش', description: 'a' -> 'ش' },
			{ input: 's',  output: 'س', description: 's' -> 'س' },
			{ input: 'd',  output: 'ی', description: 'd' -> 'ی' },
			{ input: 'f',  output: 'ب', description: 'f' -> 'ب' },
			{ input: 'g',  output: 'ل', description: 'g' -> 'ل' },
			{ input: 'h',  output: 'ا', description: 'h' -> 'ا' },
			{ input: 'j',  output: 'ت', description: 'j' -> 'ت' },
			{ input: 'k',  output: 'ن', description: 'k' -> 'ن' },
			{ input: 'l',  output: 'م', description: 'l' -> 'م' },
			{ input: ';',  output: 'ک', description: ';' -> 'ک' },
			{ input: '\'',  output: 'گ', description: '\'' -> 'گ' },

			{ input: 'z',  output: 'ئ', description: 'z' -> 'ئ' },
			{ input: 'x',  output: 'ء', description: 'x' -> 'ء' },
			{ input: 'c',  output: 'ۆ', description: 'c' -> 'ۆ' },
			{ input: 'v',  output: 'ر', description: 'v' -> 'ر' },
			{ input: 'b',  output: 'لا', description: 'b' -> 'لا' },
			{ input: 'n',  output: 'ى', description: 'n' -> 'ى' },
			{ input: 'm',  output: 'ە', description: 'm' -> 'ە' },
			{ input: ',',  output: 'و', description: ',' -> 'و' },
			{ input: '.',  output: 'ز', description: '.' -> 'ز' },

			{ input: '%',  output: '٪', description: '%' -> '٪' },
			{ input: '(',  output: ')', description: '(' -> ')' },
			{ input: ')',  output: '(', description: ')' -> '(' },

			{ input: 'Q',  output: 'ض', description: 'Q' -> 'ض' },
			{ input: 'W',  output: '}', description: 'W' -> '}' },
			{ input: 'E',  output: 'ث', description: 'E' -> 'ث' },
			{ input: 'R',  output: '{', description: 'R' -> '{' },
			{ input: 'T',  output: 'ڤ', description: 'T' -> 'ڤ' },
			{ input: 'Y',  output: 'إ', description: 'Y' -> 'إ' },
			{ input: 'U',  output: 'ۊ', description: 'U' -> 'ۊ' },
			{ input: 'I',  output: '\'', description: 'I' -> '\'' },
			{ input: 'O',  output: '"', description: 'O' -> '"' },
			{ input: 'P',  output: '؛', description: 'P' -> '؛' },
			{ input: '{',  output: '>', description: '{' -> '>' },
			{ input: '}',  output: '<', description: '}' -> '<' },

			{ input: 'A',  output: '[', description: 'A' -> '[' },
			{ input: 'S',  output: ']', description: 'S' -> ']' },
			{ input: 'D',  output: 'ێ', description: 'D' -> 'ێ' },
			{ input: 'F',  output: '', description: 'F' -> '' },
			{ input: 'G',  output: 'ڵ', description: 'G' -> 'ڵ' },
			{ input: 'H',  output: 'أ', description: 'H' -> 'أ' },
			{ input: 'J',  output: 'ـ', description: 'J' -> 'ـ' },
			{ input: 'K',  output: '،', description: 'K' -> '،' },
			{ input: 'L',  output: '\\', description: 'L' -> '\\' },
			{ input: '"',  output: 'ط', description: '"' -> 'ط' },

			{ input: 'Z',  output: 'ڎ', description: 'Z' -> 'ڎ' },
			{ input: 'X',  output: 'وو', description: 'X' -> 'وو' },
			{ input: 'C',  output: 'ؤ', description: 'C' -> 'ؤ' },
			{ input: 'V',  output: 'ڕ', description: 'V' -> 'ڕ' },
			{ input: 'B',  output: 'ڵا', description: 'B' -> 'ڵا' },
			{ input: 'N',  output: 'آ', description: 'N' -> 'آ' },
			{ input: 'M',  output: 'ة', description: 'M' -> 'ة' },
			{ input: '<',  output: '٫', description: '<' -> '٫' },
			{ input: '>',  output: '.', description: '>' -> '.' },
			{ input: '?',  output: '؟', description: '?' -> '؟' }
		],
		...
		tests: [
			...
			{ input: 'q',  output: 'ڵ', description: 'q' -> 'ڵ' },
			{ input: 'w',  output: 'ۆ', description: 'w' -> 'ۆ' },
			{ input: 'e',  output: 'ێ', description: 'e' -> 'ێ' },
			{ input: 'r',  output: 'ق', description: 'r' -> 'ق' },
			{ input: 't',  output: 'ف', description: 't' -> 'ف' },
			{ input: 'y',  output: 'غ', description: 'y' -> 'غ' },
			{ input: 'u',  output: 'ع', description: 'u' -> 'ع' },
			{ input: 'i',  output: 'ە', description: 'i' -> 'ە' },
			{ input: 'o',  output: 'خ', description: 'o' -> 'خ' },
			{ input: 'p',  output: 'ح', description: 'p' -> 'ح' },
			{ input: '[',  output: 'ج', description: '[' -> 'ج' },
			{ input: ']',  output: 'چ', description: ']' -> 'چ' },
			{ input: '\\',  output: 'ژ', description: '\\' -> 'ژ' },
			...
			{ input: 'z',  output: 'ڤ', description: 'z' -> 'ڤ' },
			{ input: 'x',  output: 'ھ', description: 'x' -> 'ھ' },
			{ input: 'c',  output: 'ز', description: 'c' -> 'ز' },
			{ input: 'v',  output: 'ر', description: 'v' -> 'ر' },
			{ input: 'b',  output: 'ڕ', description: 'b' -> 'ڕ' },
			{ input: 'n',  output: 'د', description: 'n' -> 'د' },
			{ input: 'm',  output: 'ئ', description: 'm' -> 'ئ' },
			{ input: ',',  output: 'و', description: ',' -> 'و' },
			{ input: '.',  output: '.', description: '.' -> '.' },
			{ input: '/',  output: '/', description: '/' -> '/' },
			...
			{ input: 'W',  output: 'ص', description: 'W' -> 'ص' },
			{ input: 'E',  output: 'ث', description: 'E' -> 'ث' },
			{ input: 'R',  output: 'ك', description: 'R' -> 'ك' },
			{ input: 'T',  output: '،', description: 'T' -> '،' },
			{ input: 'Y',  output: '؛', description: 'Y' -> '؛' },
			{ input: 'U',  output: '\\', description: 'U' -> '\\' },
			{ input: 'I',  output: ']', description: 'I' -> ']' },
			{ input: 'O',  output: '[', description: 'O' -> '[' },
			{ input: 'P',  output: '\'', description: 'P' -> '\'' },
			{ input: '{',  output: '}', description: '{' -> '}' },
			...
			{ input: 'A',  output: 'ڎ', description: 'A' -> 'ڎ' },
			{ input: 'S',  output: 'إ', description: 'S' -> 'إ' },
			{ input: 'D',  output: 'ي', description: 'D' -> 'ي' },
			{ input: 'F',  output: 'ة', description: 'F' -> 'ة' },
			{ input: 'G',  output: 'ۀ', description: 'G' -> 'ۀ' },
			{ input: 'H',  output: 'آ', description: 'H' -> 'آ' },
			{ input: 'J',  output: 'ـ', description: 'J' -> 'ـ' },
			{ input: 'K',  output: '»', description: 'K' -> '»' },
			{ input: 'L',  output: '«', description: 'L' -> '«' },

			{ input: 'Z',  output: 'ظ', description: 'Z' -> 'ظ' },
			{ input: 'X',  output: 'ط', description: 'X' -> 'ط' },
			{ input: 'C',  output: 'ژ', description: 'C' -> 'ژ' },
			{ input: 'V',  output: 'ؤ', description: 'V' -> 'ؤ' },
			{ input: 'B',  output: 'ذ', description: 'B' -> 'ذ' },
			{ input: 'N',  output: '‌أ', description: 'N' -> '‌أ' },
			{ input: 'M',  output: 'ء', description: 'M' -> 'ء' },
			{ input: '<',  output: '>', description: '<' -> '>' },
			{ input: '>',  output: '<', description: '>' -> '<' },
			{ input: '?',  output: '؟', description: '?' -> '؟' }
		],
		...
		tests: [
			...
			{ input: 'q',  output: 'ق', description: 'q' -> 'ق' },
			{ input: 'w',  output: 'و', description: 'w' -> 'و' },
			{ input: 'e',  output: 'ە', description: 'e' -> 'ە' },
			{ input: 'r',  output: 'ر', description: 'r' -> 'ر' },
			{ input: 't',  output: 'ت', description: 't' -> 'ت' },
			{ input: 'y',  output: 'ی', description: 'y' -> 'ی' },
			{ input: 'u',  output: 'ئ', description: 'u' -> 'ئ' },
			{ input: 'i',  output: 'ح', description: 'i' -> 'ح' },
			{ input: 'o',  output: 'ۆ', description: 'o' -> 'ۆ' },
			{ input: 'p',  output: 'پ', description: 'p' -> 'پ' },
			{ input: '[',  output: ']', description: '[' -> ']' },
			{ input: ']',  output: '[', description: ']' -> '[' },

			{ input: 'a',  output: 'ا', description: 'a' -> 'ا' },
			{ input: 's',  output: 'س', description: 's' -> 'س' },
			{ input: 'd',  output: 'د', description: 'd' -> 'د' },
			{ input: 'f',  output: 'ف', description: 'f' -> 'ف' },
			{ input: 'g',  output: 'گ', description: 'g' -> 'گ' },
			{ input: 'h',  output: 'ھ', description: 'h' -> 'ھ' },
			{ input: 'j',  output: 'ژ', description: 'j' -> 'ژ' },
			{ input: 'k',  output: 'ک', description: 'k' -> 'ک' },
			{ input: 'l',  output: 'ل', description: 'l' -> 'ل' },
			{ input: ';',  output: '؛', description: ';' -> '؛' },

			{ input: 'z',  output: 'ز', description: 'z' -> 'ز' },
			{ input: 'x',  output: 'خ', description: 'x' -> 'خ' },
			{ input: 'c',  output: 'ج', description: 'c' -> 'ج' },
			{ input: 'v',  output: 'ڤ', description: 'v' -> 'ڤ' },
			{ input: 'b',  output: 'ب', description: 'b' -> 'ب' },
			{ input: 'n',  output: 'ن', description: 'n' -> 'ن' },
			{ input: 'm',  output: 'م', description: 'm' -> 'م' },
			{ input: ',',  output: '،', description: ',' -> '،' },
			{ input: '.',  output: '.', description: '.' -> '.' },
			...
			{ input: 'Q',  output: 'ڎ', description: 'Q' -> 'ڎ' },
			{ input: 'W',  output: 'وو', description: 'W' -> 'وو' },
			{ input: 'E',  output: 'ێ', description: 'E' -> 'ێ' },
			{ input: 'R',  output: 'ڕ', description: 'R' -> 'ڕ' },
			{ input: 'T',  output: 'ط', description: 'T' -> 'ط' },
			{ input: 'Y',  output: 'ي', description: 'Y' -> 'ي' },
			{ input: 'U',  output: 'ء', description: 'U' -> 'ء' },
			{ input: 'I',  output: 'ع', description: 'I' -> 'ع' },
			{ input: 'O',  output: 'ؤ', description: 'O' -> 'ؤ' },
			{ input: 'P',  output: 'ث', description: 'P' -> 'ث' },
			{ input: '{',  output: '}', description: '{' -> '}' },
			{ input: '}',  output: '{', description: '}' -> '{' },

			{ input: 'A',  output: 'آ', description: 'A' -> 'آ' },
			{ input: 'S',  output: 'ش', description: 'S' -> 'ش' },
			{ input: 'D',  output: 'ذ', description: 'D' -> 'ذ' },
			{ input: 'F',  output: 'إ', description: 'F' -> 'إ' },
			{ input: 'G',  output: 'غ', description: 'G' -> 'غ' },
			{ input: 'H',  output: 'ه', description: 'H' -> 'ه' },
			{ input: 'J',  output: 'أ', description: 'J' -> 'أ' },
			{ input: 'K',  output: 'ك', description: 'K' -> 'ك' },
			{ input: 'L',  output: 'ڵ', description: 'L' -> 'ڵ' },

			{ input: 'Z',  output: 'ض', description: 'Z' -> 'ض' },
			{ input: 'X',  output: 'ص', description: 'X' -> 'ص' },
			{ input: 'C',  output: 'چ', description: 'C' -> 'چ' },
			{ input: 'V',  output: 'ظ', description: 'V' -> 'ظ' },
			{ input: 'B',  output: 'ى', description: 'B' -> 'ى' },
			{ input: 'N',  output: 'ة', description: 'N' -> 'ة' },
			{ input: 'M',  output: 'ـ', description: 'M' -> 'ـ' },
			{ input: '<',  output: '>', description: '<' -> '>' },
			{ input: '>',  output: '<', description: '>' -> '<' },
			{ input: '?',  output: '؟', description: '?' -> '؟' }
		],
