...
var palochkaVariants = {
	...
	*/
	...
	},
	{
		...
		inputmethod: 'ks-kbd',
		tests: [
			{ input: 'aW', output: 'آ', description: 'Kashmiri kbd aW -> alef madda' },
			...
			{ input: 'Q', output: 'ۄ', description: 'Kashmiri kbd waw with ring' },
			...
			{ input: 'bP', output: 'بٕ', description: 'Kashmiri kbd P - Hamza below' },
			...
			{ input: 'mL', output: 'مٟ', description: 'Kashmiri wavy hamza below' },
