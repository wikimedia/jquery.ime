...
var palochkaVariants = {
	...
	},
	{
		...
		tests: [
			...
			{ input: 'Ng', output: '𑢪', description: 'Ho Ng' },
			{ input: 'Nn', output: '𑢰', description: 'Ho Nn' },
			{ input: 'v', output: '𑣀', description: 'Ho v' },
			{ input: 'V', output: '𑢠', description: 'Ho V' },
			{ input: '\@', output: '𑣿', description: 'Ho \@' },
			{ input: 'aimin', output: '𑣆𑣖𑣂𑣓', description: 'Ho aimin' },
			{ input: 'aurub', output: '𑣇𑣜𑣃𑣗', description: 'Ho aurub' },
			...
			{ input: 'Wrang Cithi', output: '𑢿𑣜𑣁𑣊 𑢯𑣂𑣕𑣂', description: 'Ho Wrang Cithi' },
			{ input: 'ravsa', output: '𑣜𑣁𑣀𑣞𑣁', description: 'Ho ravsa' },
			{ input: 'Aipilsinggi', output: '𑢦𑣘𑣂𑣚𑣞𑣂𑣊𑣋𑣂', description: 'Ho Aipilsinggi' },
