...
var testFixtures = [
	{
		...
		tests: [
			...
			{ input: 'ning', output: 'ꦤꦶꦁ', description: 'testing "cecak" (word ends with "ng")' },
			{ input: 'cor', output: 'ꦕꦺꦴꦂ', description: 'testing "layar" (word ends with "r")' },
			{ input: 'reh', output: 'ꦫꦺꦃ', description: 'testing "wignyan" (word ends with "h")' },
			{ input: 'kya', output: 'ꦏꦾ​', description: 'testing "pengkal" (word with "-y-" in the middle)' },
			{ input: 'dra', output: 'ꦢꦿ​', description: 'testing "cakra" (word with "-r-" in the middle)' },
			{ input: 'trx', output: 'ꦠꦽ', description: 'testing "cakra keret" (word with "-r-" in the middle, and ends with "ê")' }
		],
