...
var palochkaVariants = {
	...
	*/
	...
	},
	{
		...
		inputmethod: 'kor-rr',
		tests: [
			// Romanization rules taken from https://www.korean.go.kr/front_eng/roman/roman_01.do
			// Note that this interface is for typing written Korean, which may often diverge from
			// the proper pronunciation, which makes it different from standard RR transcription.
			// The transcription used here is much closer to the "academic" RR as described at the
			// bottom of the above link. 
			// { input: 'eobs-eoss-seubnida ', output: '없었습니다', description: 'eobs-eoss-seubnida -> 없었습니다'},
			// { input: 'gagog ', output: '가곡', description: 'gagog -> 가곡'},
			// { input: 'gud-i ', output: '굳이', description: 'gud-i -> 굳이'},
			// { input: 'munli ', output: '문리', description: 'munli -> 문리'},
			// { input: 'meogneun ', output: '먹는', description: 'meogneun -> 먹는'},
			// { input: 'gabs ', output: '값', description: 'gabs -> 값'},
			// { input: 'jip ', output: '짚', description: 'jip -> 짚'},
			// { input: 'jolangmal ', output: '조랑말', description: 'jolangmal -> 조랑말'},
			// { input: 'johda ', output: '좋다', description: 'johda -> 좋다'},
			// { input: 'mul-yeos ', output: '물엿', description: 'yeos -> 물엿'},
			// { input: 'doglib ', output: '독립', description: 'doglib -> 독립'},
			// { input: 'buskkoch ', output: '붓꽃', description: 'buskkoch -> 붓꽃'},
			// { input: 'bakk ', output: '밖', description: 'bakk -> 밖'},
			// { input: 'jib ', output: '집', description: 'jib -> 집'},
			// RR that is phonetically accurate should work as well
			{ input: 'namsan ', output: '남산', description: 'Namsan -> 남산'},
			{ input: 'dokdo ', output: '독도', description: 'Dokdo -> 독도'},
			{ input: 'yeon-hwagyo ', output: '연화교', description: 'Yeonhwagyo -> 연화교'},
			...
			// { input: 'chokseongnu ', output: '촉석루', description: 'Chokseongnu -> 촉석루'},
			{ input: 'geumgang ', output: '금강', description: 'Geumgang -> 금강'},
			// { input: 'songnisan ', output: '속리산', description: 'Songnisan -> 속리산'},
			{ input: 'mu-ryangsu-jeon ', output: '무량수전', description: 'Muryangsujeon -> 무량수전'},
			{ input: 'gyeongbokgung ', output: '경복궁', description: 'Gyeongbokgung -> 경복궁'},
			{ input: 'anabji ', output: '안압지', description: 'Anapji -> 안압지'},
			{ input: 'geukrakjeon ', output: '극락전', description: 'Geungnakjeon -> 극락전'},
			{ input: 'bulguksa ', output: '불국사', description: 'Bulguksa -> 불국사'},
			{ input: 'hwarangdae ', output: '화랑대', description: 'Hwarangdae -> 화랑대'},
			{ input: 'ojukheon ', output: '오죽헌', description: 'Ojukheon -> 오죽헌'},
			{ input: 'dongnimmun ', output: '독립문', description: 'Dongnimmun -> 독립문'},
			{ input: 'dabotap ', output: '다보탑', description: 'Dabotap -> 다보탑'},
			...
			{ input: 'seun ',  output: '슨', description: 'Seun -> 슨'},
			...
			{ input: 'hong Bitna ', output: '홍빛나', description: 'Hong Bitna -> 홍빛나'},
			{ input: 'hong Bit-na ', output: '홍빛나', description: 'Hong Bit-na -> 홍빛나'},
			// Tense (or glottalized) sounds are not transcribed in cases where morphemes are compounded
			{ input: 'apgujeong ', output: '압구정', description: 'Apgujeong -> 압구정'},
			{ input: 'hapjeong ', output: '합정', description: 'Hapjeong -> 합정'},
			...
			{ input: 'nakseongdae ', output: '낙성대', description: 'Nakseongdae -> 낙성대'},
			{ input: 'ulsan ', output: '울산', description: 'Ulsan -> 울산'},
