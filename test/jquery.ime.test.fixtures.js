...
var testFixtures = [
	{
		...
		tests: [
			...
			{ input: 'i', output: 'ه', description: 'Northern Luri Keyboard Layout: i -> ه' },
			...
			{ input: 'F', output: 'ئى', description: 'Northern Luri Keyboard Layout: F -> ئى' },
			...
			{ input: 'V', output: 'ێ', description: 'Northern Luri Keyboard Layout: V -> ێ' },
