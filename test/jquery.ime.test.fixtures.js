	...
	*/
	...
	},
	{
		...
		tests: [
			...
			{ input: 'Yeonhwagyo', output: '연화교', description: 'Yeonhwagyo -> 연화교'},
			...
			{ input: 'Muryangsujeon', output: '무량수전', description: 'Muryangsujeon -> 무량수전'},
			{ input: 'Gyeongbokgung', output: '경복궁', description: 'Gyeongbokgung -> 경복궁'},
			{ input: 'Anapji', output: '안압지', description: 'Anapji -> 안압지'},
			{ input: 'Geungnakjeon', output: '극락전', description: 'Geungnakjeon -> 극락전'},
