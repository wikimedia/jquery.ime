	...
	*/
	...
	},
	{
		...
		tests: [
			...
			{ input: 'kropak', output: 'ꦏꦿꦺꦴꦥꦏ꧀', description: 'kropak: https://jv.wikisource.org/wiki/Parembugan_Kaca:Serat_Pararaton.pdf/16 by Empat Tilda' },
			{ input: 'cakru', output: 'ꦕꦏꦿꦸ', description: '"cakra" + "suku"' },
			{ input: 'krupuk', output: 'ꦏꦿꦸꦥꦸꦏ꧀', description: 'krupuk' },
			{ input: 'cakrx', output: 'ꦕꦏꦽ', description: '"cakra" + "pepet"' },
			{ input: 'kasrxmpillan', output: 'ꦏꦱꦽꦩ꧀ꦥꦶꦭ꧀ꦭꦤ꧀', description: 'kasrempilan: https://jv.wikisource.org/wiki/Parembugan_Kaca:Serat_Pararaton.pdf/17 by Empat Tilda' },
