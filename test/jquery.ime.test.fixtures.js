...
var testFixtures = [
	{
		...
		tests: [
			...
			{ input: '"',  output: '؛', description: 'South Azerbaijani Keyboard Layout: " -> ؛' },
			{ input: 'Z',  output: '|', description: 'South Azerbaijani Keyboard Layout: Z -> |' },
			{ input: 'X',  output: 'ك', description: 'South Azerbaijani Keyboard Layout: X -> ك' },
			{ input: 'C',  output: 'ط', description: 'South Azerbaijani Keyboard Layout: C -> ط' },
			{ input: 'V',  output: 'ژ', description: 'South Azerbaijani Keyboard Layout: V -> ژ' },
		...
		description: 'Western Baluchi Arabic keyboard based on Persian keyboard test',
		tests: [
			{ input: '`',  output: '\u200c', description: 'Western Baluchi Arabic keyboard based on Persian: ` -> \\u200c' },
			{ input: '1',  output: '١', description: 'Western Baluchi Arabic keyboard based on Persian: 1 -> ١' },
			{ input: '2',  output: '٢', description: 'Western Baluchi Arabic keyboard based on Persian: 2 -> ٢' },
			{ input: '3',  output: '٣', description: 'Western Baluchi Arabic keyboard based on Persian: 3 -> ٣' },
			{ input: '4',  output: '۴', description: 'Western Baluchi Arabic keyboard based on Persian: 4 -> ۴' },
			{ input: '5',  output: '۵', description: 'Western Baluchi Arabic keyboard based on Persian: 5 -> ۵' },
			{ input: '6',  output: '۶', description: 'Western Baluchi Arabic keyboard based on Persian: 6 -> ۶' },
			{ input: '7',  output: '۷', description: 'Western Baluchi Arabic keyboard based on Persian: 7 -> ۷' },
			{ input: '8',  output: '۸', description: 'Western Baluchi Arabic keyboard based on Persian: 8 -> ۸' },
			{ input: '9',  output: '۹', description: 'Western Baluchi Arabic keyboard based on Persian: 9 -> ۹' },
			{ input: '0',  output: '۰', description: 'Western Baluchi Arabic keyboard based on Persian: 0 -> ۰' },

			{ input: 'q',  output: 'ض', description: 'Western Baluchi Arabic keyboard based on Persian: q -> ض' },
			{ input: 'w',  output: 'ص', description: 'Western Baluchi Arabic keyboard based on Persian: w -> ص' },
			{ input: 'e',  output: 'ث', description: 'Western Baluchi Arabic keyboard based on Persian: e -> ث' },
			{ input: 'r',  output: 'ق', description: 'Western Baluchi Arabic keyboard based on Persian: r -> ق' },
			{ input: 't',  output: 'ف', description: 'Western Baluchi Arabic keyboard based on Persian: t -> ف' },
			{ input: 'y',  output: 'غ', description: 'Western Baluchi Arabic keyboard based on Persian: y -> غ' },
			{ input: 'u',  output: 'ع', description: 'Western Baluchi Arabic keyboard based on Persian: u -> ع' },
			{ input: 'i',  output: 'ھ', description: 'Western Baluchi Arabic keyboard based on Persian: i -> ھ' },
			{ input: 'o',  output: 'خ', description: 'Western Baluchi Arabic keyboard based on Persian: o -> خ' },
			{ input: 'p',  output: 'ح', description: 'Western Baluchi Arabic keyboard based on Persian: p -> ح' },
			{ input: '[',  output: 'ج', description: 'Western Baluchi Arabic keyboard based on Persian: [ -> ج' },
			{ input: ']',  output: 'چ', description: 'Western Baluchi Arabic keyboard based on Persian: ] -> چ' },

			{ input: 'a',  output: 'ش', description: 'Western Baluchi Arabic keyboard based on Persian: a -> ش' },
			{ input: 's',  output: 'س', description: 'Western Baluchi Arabic keyboard based on Persian: s -> س' },
			{ input: 'd',  output: 'ی', description: 'Western Baluchi Arabic keyboard based on Persian: d -> ی' },
			{ input: 'f',  output: 'ب', description: 'Western Baluchi Arabic keyboard based on Persian: f -> ب' },
			{ input: 'g',  output: 'ل', description: 'Western Baluchi Arabic keyboard based on Persian: g -> ل' },
			{ input: 'h',  output: 'ا', description: 'Western Baluchi Arabic keyboard based on Persian: h -> ا' },
			{ input: 'j',  output: 'ت', description: 'Western Baluchi Arabic keyboard based on Persian: j -> ت' },
			{ input: 'k',  output: 'ن', description: 'Western Baluchi Arabic keyboard based on Persian: k -> ن' },
			{ input: 'l',  output: 'م', description: 'Western Baluchi Arabic keyboard based on Persian: l -> م' },
			{ input: ';',  output: 'ک', description: 'Western Baluchi Arabic keyboard based on Persian: ; -> ک' },
			{ input: '\'',  output: 'گ', description: 'Western Baluchi Arabic keyboard based on Persian: \' -> گ' },

			{ input: 'z',  output: 'ظ', description: 'Western Baluchi Arabic keyboard based on Persian: z -> ظ' },
			{ input: 'x',  output: 'ط', description: 'Western Baluchi Arabic keyboard based on Persian: x -> ط' },
			{ input: 'c',  output: 'ز', description: 'Western Baluchi Arabic keyboard based on Persian: c -> ز' },
			{ input: 'v',  output: 'ر', description: 'Western Baluchi Arabic keyboard based on Persian: v -> ر' },
			{ input: 'b',  output: 'ڈ', description: 'Western Baluchi Arabic keyboard based on Persian: b -> ڈ' },
			{ input: 'n',  output: 'د', description: 'Western Baluchi Arabic keyboard based on Persian: n -> د' },
			{ input: 'm',  output: 'پ', description: 'Western Baluchi Arabic keyboard based on Persian: m -> پ' },
			{ input: ',',  output: 'و', description: 'Western Baluchi Arabic keyboard based on Persian: , -> و' },
			...
			{ input: '(',  output: ')', description: 'Western Baluchi Arabic keyboard based on Persian: ( -> )' },
			{ input: ')',  output: '(', description: 'Western Baluchi Arabic keyboard based on Persian: ) -> (' },
			{ input: '_',  output: 'ـ', description: 'Western Baluchi Arabic keyboard based on Persian: _ -> ـ' },

			{ input: 'Q',  output: 'ْ', description: 'Western Baluchi Arabic keyboard based on Persian: Q -> ْ' },
			{ input: 'W',  output: 'ٌ', description: 'Western Baluchi Arabic keyboard based on Persian: W -> ٌ' },
			{ input: 'E',  output: 'ٍ', description: 'Western Baluchi Arabic keyboard based on Persian: E -> ٍ' },
			{ input: 'R',  output: 'ً', description: 'Western Baluchi Arabic keyboard based on Persian: R -> ً' },
			{ input: 'T',  output: 'ُ', description: 'Western Baluchi Arabic keyboard based on Persian: T -> ُ' },
			{ input: 'Y',  output: 'ِ', description: 'Western Baluchi Arabic keyboard based on Persian: Y -> ِ' },
			{ input: 'U',  output: 'َ', description: 'Western Baluchi Arabic keyboard based on Persian: U -> َ' },
			{ input: 'I',  output: 'ّ', description: 'Western Baluchi Arabic keyboard based on Persian: I -> ّ' },
			{ input: 'O',  output: ']', description: 'Western Baluchi Arabic keyboard based on Persian: O -> ]' },
			{ input: 'P',  output: '[', description: 'Western Baluchi Arabic keyboard based on Persian: P -> [' },
			{ input: '{',  output: '}', description: 'Western Baluchi Arabic keyboard based on Persian: { -> }' },
			{ input: '}',  output: '{', description: 'Western Baluchi Arabic keyboard based on Persian: } -> {' },

			{ input: 'A',  output: 'ؤ', description: 'Western Baluchi Arabic keyboard based on Persian: A -> ؤ' },
			{ input: 'S',  output: 'ئ', description: 'Western Baluchi Arabic keyboard based on Persian: S -> ئ' },
			{ input: 'D',  output: 'ي', description: 'Western Baluchi Arabic keyboard based on Persian: D -> ي' },
			{ input: 'F',  output: 'إ', description: 'Western Baluchi Arabic keyboard based on Persian: F -> إ' },
			{ input: 'G',  output: 'أ', description: 'Western Baluchi Arabic keyboard based on Persian: G -> أ' },
			{ input: 'H',  output: 'آ', description: 'Western Baluchi Arabic keyboard based on Persian: H -> آ' },
			{ input: 'J',  output: 'ٹ', description: 'Western Baluchi Arabic keyboard based on Persian: J -> ٹ' },
			{ input: 'K',  output: '»', description: 'Western Baluchi Arabic keyboard based on Persian: K -> »' },
			{ input: 'L',  output: '«', description: 'Western Baluchi Arabic keyboard based on Persian: L -> «' },
			{ input: '"',  output: '؛', description: 'Western Baluchi Arabic keyboard based on Persian: " -> ؛' },

			{ input: 'Z',  output: 'ێ', description: 'Western Baluchi Arabic keyboard based on Persian: Z -> ێ' },
			{ input: 'X',  output: 'ه', description: 'Western Baluchi Arabic keyboard based on Persian: X -> ه' },
			{ input: 'C',  output: 'ژ', description: 'Western Baluchi Arabic keyboard based on Persian: C -> ژ' },
			{ input: 'V',  output: 'ڑ', description: 'Western Baluchi Arabic keyboard based on Persian: V -> ڑ' },
			{ input: 'B',  output: 'ۆ', description: 'Western Baluchi Arabic keyboard based on Persian: B -> ۆ' },
			{ input: 'N',  output: 'ٔ', description: 'Western Baluchi Arabic keyboard based on Persian: N -> ٔ' },
			{ input: 'M',  output: 'ء', description: 'Western Baluchi Arabic keyboard based on Persian: M -> ء' },
			{ input: '<',  output: '>', description: 'Western Baluchi Arabic keyboard based on Persian: < -> >' },
			{ input: '>',  output: '<', description: 'Western Baluchi Arabic keyboard based on Persian: > -> <' },
			{ input: '?',  output: '؟', description: 'Western Baluchi Arabic keyboard based on Persian: ? -> ؟' }
		],
		inputmethod: 'bgn-arab'
	},{
		...
		tests: [
			...
			{ input: '1',  output: '۱', description: 'Southern Kurdish Keyboard Layout: 1 -> ۱' },
			{ input: '2',  output: '۲', description: 'Southern Kurdish Keyboard Layout: 2 -> ۲' },
			{ input: '3',  output: '۳', description: 'Southern Kurdish Keyboard Layout: 3 -> ۳' },
			...
			{ input: '7',  output: '٦', description: 'Southern Kurdish Keyboard Layout: 7 -> ٦' },
			{ input: '8',  output: '۸', description: 'Southern Kurdish Keyboard Layout: 8 -> ۸' },
			{ input: '9',  output: '۹', description: 'Southern Kurdish Keyboard Layout: 9 -> ۹' },
			{ input: '0',  output: '۰', description: 'Southern Kurdish Keyboard Layout: 0 -> ۰' },
			...
			{ input: 'i',  output: 'ه', description: 'Southern Kurdish Keyboard Layout: i -> ه' },
			...
			{ input: '"',  output: '؛', description: 'Southern Kurdish Keyboard Layout: " -> ؛' },
			{ input: 'Z',  output: '\u200c', description: 'Southern Kurdish Keyboard Layout: Z -> \u200c' },
			{ input: 'X',  output: 'ط', description: 'Southern Kurdish Keyboard Layout: X -> ط' },
